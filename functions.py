...
def predict(image_path):
    """
    Fait une prédiction sur une image d'échantillon.
    """

    path_to_load = os.path.join(dir, "U6_E_1201-F1_0.7134-IOU_0.6555.h5")
...
def analyse(image_path):
    ...
    return figure_path, absorption_carbone_kg_an, tree_number