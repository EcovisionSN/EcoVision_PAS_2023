...
def predict_mask():
    ...
    try:
        ...
        print("Erreur lors du téléchargement de l'image depuis Cloudinary:", str(e))

    prediction_path = predict(image_path)
    figure_path, absorption_carbone_kg_an, tree_number = analyse(prediction_path)
